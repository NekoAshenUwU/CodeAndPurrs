...
function demoPayload(): UsagePayload {
  return {
    ...
    apps: [
      { package: 'com.xingin.xhs', label: '小红书', category: 'social', foregroundMs: 96 * 60000, lastUsedAt: `${DEMO_DATE}T22:10:00+08:00` },
      { package: 'com.tencent.mm', label: '微信', category: 'social', foregroundMs: 58 * 60000, lastUsedAt: `${DEMO_DATE}T23:40:00+08:00` },
      { package: 'com.ss.android.ugc.aweme', label: '抖音', category: 'entertainment', foregroundMs: 44 * 60000, lastUsedAt: `${DEMO_DATE}T21:30:00+08:00` },
      { package: 'com.microsoft.vscode', label: 'VS Code', category: 'work', foregroundMs: 38 * 60000, lastUsedAt: `${DEMO_DATE}T15:05:00+08:00` },
      { package: 'com.google.books', label: '微信读书', category: 'reading', foregroundMs: 16 * 60000, lastUsedAt: `${DEMO_DATE}T13:20:00+08:00` },
      { package: 'com.android.settings', label: '设置', category: 'tool', foregroundMs: 6 * 60000, lastUsedAt: `${DEMO_DATE}T09:02:00+08:00` },
    ],
    sessions: [
      ...
      { package: 'com.microsoft.vscode', label: 'VS Code', category: 'work', startAt: `${DEMO_DATE}T13:40:00+08:00`, endAt: `${DEMO_DATE}T15:05:00+08:00` },
